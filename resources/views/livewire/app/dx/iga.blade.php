...
<div class=" my-4  max-full p-2 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
    ...
    <p class="mb-2 text-sm lg:text-base text-gray-700 dark:text-gray-400"> {{$diseasedetails->IGA_presentation?? '' }}
    ...
    <a >
        <h5 class="mb-2 text-lg lg:text-2xl font-semibold  tracking-tight text-gray-900 dark:text-white">Haematuria</h5>
    </a>
    <p class="mb-2 text-sm lg:text-base text-gray-700 dark:text-gray-400"> {{$diseasedetails->IGA_heamat?? '' }}
    ...
    <p class="mb-2 text-sm lg:text-base text-gray-700 dark:text-gray-400"> {{$diseasedetails->IGA_last_secreat?? '' }}
    ...
    <p class="mb-2 text-sm lg:text-base text-gray-700 dark:text-gray-400"> {{$diseasedetails->IGA_last_egfr?? '' }}
       
    </p>
</div><div class=" my-4  max-full p-2 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
    <a >
        <h5 class="mb-2 text-lg lg:text-2xl font-semibold  tracking-tight text-gray-900 dark:text-white">Biopsy</h5>
    </a>
    <p class="mb-2 text-sm lg:text-base text-gray-700 dark:text-gray-400"> {{$diseasedetails->IGA_biopsy?? '' }}
       
    </p>
</div><div class=" my-4  max-full p-2 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
    <a >
        <h5 class="mb-2 text-lg lg:text-2xl font-semibold  tracking-tight text-gray-900 dark:text-white">Hypertension</h5>
    </a>
    <p class="mb-2 text-sm lg:text-base text-gray-700 dark:text-gray-400"> {{$diseasedetails->IGA_hypertension?? '' }}
    ...
    <p class="mb-2 text-sm lg:text-base text-gray-700 dark:text-gray-400">
        @php
        if (is_array(json_decode($diseasedetails->IGA_drugs))==true ||  $diseasedetails->IGA_drugs ==null) {
    ...
    <a >
        <h5 class="mb-2 text-lg lg:text-2xl font-semibold  tracking-tight text-gray-900 dark:text-white">CKD</h5>
    </a>
    <p class="mb-2 text-sm lg:text-base text-gray-700 dark:text-gray-400"> {{$diseasedetails->IGA_ckd?? '' }}
